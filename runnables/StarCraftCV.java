...
public class StarCraftCV {
	...
	public static Point BARRACKS, BARRACKS2, REFINERY, ARMORY, ENEMY, FACTORY,
			REFINERY2, RALLY, RALLY2;
	...
	public static void main(String[] args) {
		...
		buildOnLeft = ai.isAtBottomBaseRequest();

		if (buildOnLeft) {
			ai.debug("DETECTED BOTTOM BASE");
